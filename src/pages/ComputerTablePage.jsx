...
import SearchBox from '../components/buttons/SearchBoxUserUpdate';
import ComboBox from '../components/buttons/ComboBoxUpdateBy';


function ComputerTablePage() {
...
const [runningNumber, setRunningNumber] = useState(1);
  ...
  const fetchData = async (userUpdateBy = '') => {
    try {
  ...
  const handleCellClick = (computer, columnName) => {
    // console.log(computer, columnName);
...
export default ComputerTablePage;
