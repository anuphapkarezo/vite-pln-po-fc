...
export default function DataGridSearchPage() {
    ...
    const fetchData = async (
      ...
      try {
        const response = await fetch(`http://localhost:3002/api/computer-list-fac-dep-proc?factorySelect=${selectedFactory}&departmentSelect=${selectedDepartment}&processSelect=${selectedProcess}`);
        if (!response.ok) {
...
//   });
  ...
  const columns = [
    { field: "runningnumber", headerName: "No", width: 50 , headerAlign: "center" , align: "center"},
    { field: "computer_name", headerName: "Computer Name", width: 150 , headerAlign: "center"},
    { field: "factory", headerName: "Factory", width: 150, headerAlign: "center" ,
      renderCell: (params) => (
        <div>
    ...
    { field: "department", headerName: "Department", width: 150 , headerAlign: "center"},
    { field: "process", headerName: "Process", width: 150 , headerAlign: "center"},
    { field: "area_room", headerName: "Area Room", width: 200 , headerAlign: "center"},
    { field: "computer_type", headerName: "Computer Type", width: 200 , headerAlign: "center",
      renderCell: (params) => (
        <div>
          
          {params.row.computer_type === "Desktop" ? (
            <ConnectedTvTwoToneIcon style={{ color: 'red' }} /> // Replace with the icon for Desktop
          ) : (
            <LaptopTwoToneIcon style={{ color: 'purple' }} /> // Replace with the icon for Notebook
          )}
          &nbsp;&nbsp;{params.value}
        </div>
      ),
  ...
  return (
    <div className='container'>
        <div>
          <SearchFactoryDepartmentProcess
