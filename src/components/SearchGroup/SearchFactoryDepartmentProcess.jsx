...
function SearchFactoryDepartmentProcess({ onSearch }) {
    ...
    const fetchProcess = async () => {
        try {
          const response = await axios.get(`http://127.0.0.1:3002/api/department-filter-process?factorySelect=${selectedFactory.factory}&departmentSelect=${selectedDepartment.department}`);
          const dataProcess = response.data;
          setDistinctProcess(dataProcess);
        } catch (error) {
          console.error(`Error fetching distinct process: ${error}`);
        }
    };
                ...
                <Grid container spacing={2}>
                    ...
                    <Grid item xs={3} md={3}>
                        <Autocomplete
                            ...
                            size="small"
                            // options={distinctDepartment}
                            options={[{ process: "All" }, ...distinctProcess]}
...
export default SearchFactoryDepartmentProcess